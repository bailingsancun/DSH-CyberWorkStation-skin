...
本改版参照了 onimai.jp 官网的风格:

- **绪山真寻皮肤** —— 启动器整体换肤为真寻主题(以 `onimai` 启动器皮肤形式随包分发):侧边栏参考 onimai.jp 官网背景布局、左下角圆形头像按钮、粒子背景、站酷快乐体字体、onimai 风格的占比与悬停态;
...
- **细节打磨** —— 完整圆过场动画、参考官网占比的圆形按钮、漂浮粒子、刷新/加载动效、中英双语界面。
